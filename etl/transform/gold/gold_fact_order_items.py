...
def run():
    with PipelineAuditor(
        ...
        ORDERS_PATH  = PROJECT_ROOT / "data_lake" / "curated" / execution_date / "fact_orders.parquet"
        OUTPUT_PATH = PROJECT_ROOT / "data_lake" / "curated" / execution_date / "fact_order_items.parquet"
